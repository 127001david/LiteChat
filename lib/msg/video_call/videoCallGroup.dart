...
class VideoCallGroupPage extends StatefulWidget {
  /// non-modifiable channel name of the page
  final String channelName;

  /// Creates a call page with given channel name.
  const VideoCallGroupPage({Key key, this.channelName}) : super(key: key);

  @override
  _VideoCallGroupState createState() => _VideoCallGroupState();
}
